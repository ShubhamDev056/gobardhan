                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-12 pl-35 md-pt-40 md-pl-15">
                            <div class="row">
								<div class="col-sm-12">
									<h3>SATAT Nodal Officers</h3>
									<a href="javascript:void(0)" onclick="window.history.back()" > <i class="fa fa-arrow-left" ></i> Back </a>
								</div>
								
								<?php 
									foreach($satatOfficers as $satatOfficer){ ?>
										<div class="col-md-6 mb-20">
											<div class="rs-addon-number">
												<div class="number-text">
													<ul class="list-group list-group-flush">
														<li class="list-group-item"><h3 class="title"> <?=$satatOfficer['state_name']?> (<?=$satatOfficer['ogmc']?>) </h3></li>
														<li class="list-group-item">
															<i class="fa fa-user"></i>
															<strong><?=$satatOfficer['nodal_officer_name']?>, <?=$satatOfficer['designation']?></strong>
														</li>
														<li class="list-group-item">
