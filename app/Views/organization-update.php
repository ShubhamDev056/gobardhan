                    ...
                    <fieldset class="border p-4 py-1 mb-3 pb-4">
                        ...
                        <div class="row">
                                ...
                                <select class="form-select" name="entity_type" id="entity_type" required >									
                                    ...
                                    <?php 
                                        foreach($entities as $entity){ ?>
                                            <option value="<?=$entity['id']?>" <?php if($entity['id']==$org['entity_type']){ echo "selected"; } ?> ><?=$entity['title']?></option>
                                        <?php 
                                        }	
                                    ?>
                                </select>
                            </div>
							<div class="col-sm-12 col-12 mb-2 " id="sub_entity_sec">
                                ...
                                <select class="form-select" name="sub_entity" id="sub_entity"  >
									...
									<?php 
										foreach($subtypes as $subtype){ ?>
											<option value="<?=$subtype['id']?>" <?php if($subtype['id']==$org['entity_subtype']){ echo "selected"; } ?> ><?=$subtype['title']?></option>
										<?php	
										}
									?>
                                </select>
							...
							<div class="col-sm-12 col-12 mb-2">
                                ...
                                <input type="text" class="form-control" name="entity_name" id="entity_name" placeholder="Organization Name"  value="<?=set_value('entity_name')?:$org['entity_name'] ?>" required />
                            </div>
							
                       
                            <div class="col-sm-12 col-12 mb-2">
                                <label class="fieldlabels">1.4 Name of the Authorised Person. : </label>
                                <input type="text" name="authorised_person" value="<?=$_SESSION['name'];?>" id="authorised_person" class="form-control" placeholder="Name of the Authorised Person " />
                            </div>
                            <div class="col-sm-12 col-12 mb-2">
                            ...
                            <div class="col-sm-12 col-12 mb-2">
                                ...
                                <textarea name="entity_address" class="form-control" id="entity_address" placeholder="Address" rows="1" required ><?=$org['address']; ?></textarea>
                            </div>
                            ...
                            <div class="col-sm-12 col-12 mb-2">
                                ...
                                <select class="form-select" name="entity_state" id="entity_state" required >
                                    ...
                                    <option value="<?=$state['state_code'] ?>" <?php if($state['state_code']==$org['state_id']){ echo "selected"; } ?> ><?=$state['state_name'] ?></option>
                                    <?php } ?>
                                ...
                                <select class="form-select" name="entity_district" id="entity_district" required >
									...
									<?php
										foreach($districts as $district) { ?>
											<option value="<?=$district['district_code']?>" <?php if($district['district_code']==$org['district_id']){ echo "selected"; } ?> ><?=$district['district_name']?></option>
										<?php	
										}
									?>
                                </select>
							...
							<div class="col-sm-12 col-12 mb-2" id="ulb_code_sec" >
								...
								<select class="form-select" name="ulb_code" id="ulb_code"  >
									...
									<?php
										foreach($ulbs as $ulb) { ?>
											<option value="<?=$ulb['ulb_code']?>" <?php if($ulb['ulb_code']==$org['ulb_code']){ echo "selected"; } ?> ><?=$ulb['ulb_name']?> (<?=$ulb['ulb_code']?>)</option>
										<?php	
										}
									?>
								</select>
                            ...
                            <div class="col-sm-12 col-12 mb-2">
                                ...
                                <input type="number" name="entity_pincode" value="<?=set_value('entity_pincode')?:$org['pincode']; ?>"  id="entity_pincode" class="form-control" placeholder="Pincode" required />
                            </div>
                            ...
                            <div class="col-sm-12 col-12 mb-2 govt_optional">
                                ...
                                <input type="text" name="entity_reg_no" value="<?=set_value('entity_reg_no')?:$org['cin_reg_no']; ?>" id="entity_reg_no" class="form-control" placeholder="Registration No" />
                            </div>
                        
                            <div class="col-sm-12 col-12 mb-2 govt_optional">
                                <label class="fieldlabels">1.12 Incorporation/ registration date : <span class="govt_optional1 required">*</span> </label>
                                <input type="date" name="entity_reg_date" value="<?=set_value('entity_reg_date')?:$org['reg_date']; ?>" id="entity_reg_date" class="form-control"  />
                            </div>

                            <div class="col-sm-12 col-12 mb-2 govt_optional">
                                <label class="fieldlabels">1.13 PAN number : <span class="govt_optional1 required">*</span>  </label>
                                <input type="text" name="entity_pan_no" value="<?=set_value('entity_pan_no')?:$org['pan_no']; ?>" id="entity_pan_no" class="form-control" placeholder="PAN number" />
                            </div>
                       
                            <div class="col-sm-12 col-12 mb-2 govt_optional">
                                <label class="fieldlabels">1.14 GST number : <span class="govt_optional1 required">*</span> </label>
                                <input type="text" name="entity_gst_no" value="<?=set_value('entity_gst_no')?:$org['gst_no']; ?>" id="entity_gst_no" class="form-control" placeholder="GST number" />
                            </div>
