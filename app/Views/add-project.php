                            ...
                            <div class="row">
								...
								<div class="col-6 col-sm-6">
									...
									<select class="form-control" id="have_ministry" >
										...
										<option value="3">Registration Number under Waste to Energy (MNRE)</option>
										<option value="5">Letter of Intent (LoI) Reference Number under SATAT (MoPNG)</option>
										<option value="2">Loan Account Number under AIF (DA&FW)</option>
                        ...
                        <div class="form-card">
                            ...
                            <div class="row">
								...
								<div class="col-6 col-sm-6">
                                    ...
                                    <input type="date" name="plant_status_date" id="plant_status_date" min="<?=date('Y-m-d', strtotime('-1 month'))?>" max="<?=date('Y-m-d')?>" class="form-control" />
                                </div>
