						...
						foreach($reports as $key=>$report){ ?>
							<tr>
								...
								<td>
									...
									<?php if($_SESSION['role']=="state" && empty($report['updated_at'])){ ?>
										<a href="<?=base_url()?>monthly-update-details/<?=$report['monthly_monitoring_id'];?>" class="editReport"  ><i class="fa fa-pencil badge bg-primary text-white"> </i> </a>
									<?php
									} ?>
								</td>
							</tr>
