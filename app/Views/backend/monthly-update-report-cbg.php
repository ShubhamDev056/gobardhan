	...
	<div class="row justify-content-center">
		<div class="col-sm-12">
			<h3 style="background-color: lightblue; padding: 7px;font-weight: bold;">
				Monthly Report for the Functionality Status of CBG Plants
					...
					<?php 
						...
						?>
							<tr>
								...
								<td><?=$report['gas_production_capacity'];?> Tons/day</td>
	...
	$.ajax({
		...
		success:function(res){
			...
			if(res.current_status=="24"){ 
				...
				<li class="list-group-item"><strong>Total DBG generated (in Tons) :</strong> <span>'+ res.biogas_generation +'</span> </li>\
